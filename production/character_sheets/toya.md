...
![朝倉 透也 reference](../../images/reference/toya.png)

画像ファイル: `../../images/reference/toya.png`

## Image Prompt

Japanese all-ages manga character design sheet, front view, side view, back view, full body, same character consistency. High school older brother, slightly messy bed hair, sleepy eyes, fully clothed casual student clothes, looks a little unreliable but fundamentally kind. Black-and-white manga line art with light screentone. No speech bubbles, no text, no logo, no watermark.
