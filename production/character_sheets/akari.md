...
![朝倉 灯里 reference](../../images/reference/akari.png)

画像ファイル: `../../images/reference/akari.png`

## Image Prompt

Japanese all-ages manga character design sheet, front view, side view, back view, full body, same character consistency. Expressive school-age heroine, shoulder-length natural hair, large emotional eyes, fully clothed casual hoodie or cardigan, skirt or shorts, energetic but kind. Black-and-white manga line art with light screentone. No speech bubbles, no text, no logo, no watermark.
