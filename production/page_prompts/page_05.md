...
- This page uses only these character references: MAI / マアイ, 朝倉 透也, 朝倉 灯里.
...
8 panels: suspense from repeated doorbell. Use thin sound-beat panels, tight faces, and a small warm panel when Akari names MAI.
